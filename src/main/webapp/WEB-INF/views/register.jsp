	...
	<div class="page-heading header-text">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h3>Sign Up</h3>
					<span class="breadcrumb"><a href="#">Home</a> > Sign Up</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="col-lg-6">
				<div class="right-content">
					<div class="row">
						<div class="col-lg-12">
							<form:form id="contact-form" action="/form/user/signup"
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<fieldset>
											<form:input type="username" path="username" name="surname"
												id="surname" placeholder="Username..." autocomplete="on" />
										</fieldset>
									</div>
									<div class="col-lg-12">
										<fieldset>
									...
									<div class="col-lg-6">
										<fieldset>
											<a type="submit" id="form-submit" href="/login/user"
